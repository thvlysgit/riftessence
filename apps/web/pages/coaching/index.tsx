...
import { CreateCoachingOfferModal } from '../../../api/components/CreateCoachingOfferModal';
import { CreateCoachingRequestModal } from '../../../api/components/CreateCoachingRequestModal';
                    ...
                    <div className="space-y-4">
                      ...
                      {p.discordTag && (
                        <div className="rounded-lg p-4" style={{ background: 'var(--color-bg-tertiary)' }}>
                          ...
                          <span className="discord-chip px-3 py-1.5 rounded text-sm font-semibold border inline-flex items-center gap-2">
