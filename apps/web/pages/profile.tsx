...
const PRESTIGE_BADGE_CONFIG: Record<string, BadgeConfig> = {
  shop_fortune_coin: {
    icon: 'gem',
    description: 'Fortune Sigil I - Ember Mark',
    bgColor: 'linear-gradient(140deg, rgba(180,83,9,0.38), rgba(217,119,6,0.32))',
    borderColor: '#F97316',
    textColor: '#FED7AA',
  ...
  shop_oracle_dice: {
    icon: 'dice-d20',
    description: 'Fortune Sigil II - Ember Crest',
  ...
  shop_jackpot_crown: {
    icon: 'crown',
    description: 'Fortune Sigil III - Sovereign Crest',
  ...
  shop_vault_ascendant: {
    icon: 'trophy',
    description: 'Fortune Sigil IV - Ascendant Crown',
