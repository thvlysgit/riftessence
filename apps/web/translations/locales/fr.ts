...
export const fr = {
    ...
    'matchups.discoveryTab': 'Découverte',
    'matchups.libraryTab': 'Bibliothèque',
    'matchups.libraryHeading': 'Votre bibliothèque de matchups',
    'matchups.libraryDescription': 'Regroupez les guides en collections ou laissez-les libres. Glissez un guide sur un autre pour créer une collection.',
    'matchups.searchLibrary': 'Rechercher dans vos guides...',
    'matchups.allRoles': 'Tous les rôles',
    'matchups.allDifficulties': 'Toutes les difficultés',
    'matchups.ungrouped': 'Guides non classés',
    'matchups.noUngrouped': 'Tous vos guides sont dans des collections.',
    'matchups.dropIntoCollection': 'Glissez un guide ici pour l’ajouter à cette collection.',
    'matchups.dropToGroup': 'Déposez pour regrouper ces guides',
    'matchups.openGuide': 'Ouvrir le guide',
    'matchups.organize': 'Organiser',
    'matchups.organizeHint': 'Déplacez ce guide dans une collection ou associez-le à un autre guide pour en créer une.',
    'matchups.destination': 'Destination',
    'matchups.newWithGuide': 'Nouvelle collection avec un autre guide',
    'matchups.secondGuide': 'Autre guide',
    'matchups.optionalName': 'Nom (facultatif)',
    'matchups.ungroup': 'Déplacer hors collection',
    'matchups.rename': 'Renommer',
    'matchups.shareCollection': 'Partager',
    'matchups.collectionShared': 'La collection est maintenant publique',
    'matchups.collectionAccess': 'Accès via collection',
    'matchups.collectionPrivate': 'La collection est maintenant privée',
    'matchups.viewShareLink': 'Voir le lien',
    'matchups.deleteCollection': 'Supprimer la collection',
    'matchups.confirmDeleteCollection': 'Supprimer cette collection ? Ses guides resteront dans votre bibliothèque.',
    'matchups.confirmRemoveSaved': 'Retirer ce guide enregistré de votre bibliothèque ?',
    'matchups.saveCollection': 'Enregistrer la collection',
    'matchups.openCollection': 'Ouvrir la collection',
    'matchups.collectionSaved': 'Collection enregistrée dans votre bibliothèque',
    'matchups.collectionRemoved': 'Collection retirée de votre bibliothèque',
    'matchups.copyLink': 'Copier le lien',
    'matchups.linkCopied': 'Lien copié',
    ...
    'matchups.createCollectionDesc': 'Regroupez vos guides et les guides publics enregistrés. Les collections peuvent mélanger les champions.',
    'matchups.noCollections': 'Aucune collection pour le moment. Glissez un guide sur un autre pour en créer une.',
    ...
    'matchups.noCompatibleCollections': 'Créez d’abord une collection.',
    ...
    'navbar.purse': 'Purse',
    'navbar.teams': 'Teams',
    'navbar.learn': 'Progresser',
    'navbar.games': 'Jeux',
    'navbar.webGames': 'Jeux web',
    'navbar.arena': 'Arène',
    ...
    'navbar.findDuo': 'Trouver votre duo',
    'navbar.communitiesHint': 'Trouvez votre communauté',
    'navbar.advertiseHint': 'Faites connaître votre communauté ou projet',
    'navbar.matchupsHint': 'Votre bibliothèque de matchups',
    'navbar.coachingHint': 'Trouvez un coach et progressez',
    'navbar.webGamesHint': 'Les défis quotidiens de la Faille',
    'navbar.leaderboardsHint': 'Découvrez les classements',
    'navbar.mainNavigation': 'Navigation principale',
    'navbar.explore': 'Explorer RiftEssence',
    'navbar.account': 'Votre compte',
    'navbar.openMenu': 'Ouvrir la navigation',
    'navbar.closeMenu': 'Fermer la navigation',
    'navbar.searchHint': 'Saisissez au moins 2 caractères',
    'navbar.searchError': 'Recherche indisponible. Veuillez réessayer.',
    'navbar.verified': 'Vérifié',
    'navbar.unreadCount': '{count} non lues',
    ...
    'chat.send': 'Envoyer',
    'chat.sending': 'Envoi...',
    'chat.sendFailed': 'Le message n’a pas pu être envoyé',
    'chat.retry': 'Réessayer',
    'chat.loadOlder': 'Charger les anciens messages',
    'chat.loadingOlder': 'Chargement...',
    'chat.shiftEnterHint': 'Maj + Entrée pour une nouvelle ligne',
    'chat.conversationActions': 'Actions de conversation',
    'chat.reportUser': 'Signaler l’utilisateur',
    'chat.reportSubmitted': 'Signalement envoyé',
    'chat.reportFailed': 'Impossible d’envoyer le signalement',
    'chat.blockUser': 'Bloquer l’utilisateur',
    'chat.block': 'Bloquer',
    'chat.blockConfirm': 'Bloquer {username} ? Vous ne pourrez plus échanger de messages.',
    'chat.blockedUser': '{username} a été bloqué',
    'chat.blockFailed': 'Impossible de bloquer l’utilisateur',
    'chat.openFailed': 'Impossible d’ouvrir cette conversation',
    'chat.accountRequired': 'Tu dois avoir un compte pour utiliser le chat.',
    'chat.now': 'maintenant',
