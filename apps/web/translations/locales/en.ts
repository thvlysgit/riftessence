export const en = {
    ...
    'matchups.discoveryTab': 'Discovery',
    'matchups.libraryTab': 'Library',
    'matchups.libraryHeading': 'Your matchup library',
    'matchups.libraryDescription': 'Keep guides together in collections, or leave them ungrouped. Drag one guide onto another to create a collection.',
    'matchups.searchLibrary': 'Search your guides...',
    'matchups.allRoles': 'All roles',
    'matchups.allDifficulties': 'All difficulties',
    'matchups.ungrouped': 'Ungrouped guides',
    'matchups.noUngrouped': 'All your guides are in collections.',
    'matchups.dropIntoCollection': 'Drag a guide here to add it to this collection.',
    'matchups.dropToGroup': 'Drop to group these guides',
    'matchups.openGuide': 'Open guide',
    'matchups.organize': 'Organize',
    'matchups.organizeHint': 'Move this guide into a collection, or pair it with another guide to start one.',
    'matchups.destination': 'Destination',
    'matchups.newWithGuide': 'New collection with another guide',
    'matchups.secondGuide': 'Other guide',
    'matchups.optionalName': 'Name (optional)',
    'matchups.ungroup': 'Move to ungrouped',
    'matchups.rename': 'Rename',
    'matchups.shareCollection': 'Share',
    'matchups.collectionShared': 'Collection is now public',
    'matchups.collectionAccess': 'Collection access',
    'matchups.collectionPrivate': 'Collection is now private',
    'matchups.viewShareLink': 'View link',
    'matchups.deleteCollection': 'Delete collection',
    'matchups.confirmDeleteCollection': 'Delete this collection? Its guides will remain in your library.',
    'matchups.confirmRemoveSaved': 'Remove this saved guide from your library?',
    'matchups.saveCollection': 'Save collection',
    'matchups.openCollection': 'Open collection',
    'matchups.collectionSaved': 'Collection saved to your library',
    'matchups.collectionRemoved': 'Collection removed from your library',
    'matchups.copyLink': 'Copy link',
    'matchups.linkCopied': 'Link copied',
    ...
    'matchups.createCollectionDesc': 'Group your guides and saved public guides. Collections can mix champions.',
    'matchups.noCollections': 'No collections yet. Drag one guide onto another to make one.',
    ...
    'matchups.noCompatibleCollections': 'Create a collection first.',
    ...
    'navbar.findDuo': 'Find your duo',
    'navbar.communitiesHint': 'Find your people',
    'navbar.advertiseHint': 'Share your community or project',
    'navbar.matchupsHint': 'Your champion matchup library',
    'navbar.coachingHint': 'Find a coach, improve your game',
    'navbar.webGamesHint': 'Daily puzzles from the Rift',
    'navbar.leaderboardsHint': 'Explore the rankings',
    'navbar.mainNavigation': 'Main navigation',
    'navbar.explore': 'Explore RiftEssence',
    'navbar.account': 'Your account',
    'navbar.openMenu': 'Open navigation',
    'navbar.closeMenu': 'Close navigation',
    'navbar.searchHint': 'Enter at least 2 characters',
    'navbar.searchError': 'Search is unavailable. Please try again.',
    'navbar.verified': 'Verified',
    'navbar.unreadCount': '{count} unread',
